...
def get(link):
    urlretrieve(link,r"C:\Users\ehud\Desktop\code\captcha\temp.png")
 
#get('http://www.weizmann.ac.il/pages/he/image_captcha/23418/1377529604');
im = Image.open(r"captcha.jpg")
nx, ny = im.size
