...
_google_versions = ('1.7', '1.7.0', '1.7.1', '1.7.2','1.8.1') # since Dojo 1.7.0 an alternative loading mechanism is in place
DOJO_PROFILES = {
...
DOJO_BUILD_VERSION = getattr(settings, "DOJANGO_DOJO_BUILD_VERSION", '1.9.1')
